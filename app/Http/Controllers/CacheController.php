...
class CacheController extends Controller
{
    ...
    {
        return response()->header('timestamp', currentTimeMillis())->json(CacheManager::getCache($cacheName)) ?? response()->json(['message' => "There's not a cache with the provided name."], 404);
    }
