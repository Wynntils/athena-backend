...
class ItemManager
{
    ...
    private static function translateStatusName(string $raw): ?string
    {
        return match ($raw) {
            ...
            'mainAttackNeutralDamageBonusRaw' => 'rawNeutralMainAttackDamage',
            'mainAttackNeutralDamageBonus' => 'neutralMainAttackDamage',
            'mainAttackEarthDamageBonusRaw' => 'rawEarthMainAttackDamage',
            'mainAttackEarthDamageBonus' => 'earthMainAttackDamage',
            'mainAttackThunderDamageBonusRaw' => 'rawThunderMainAttackDamage',
            'mainAttackThunderDamageBonus' => 'thunderMainAttackDamage',
            'mainAttackWaterDamageBonusRaw' => 'rawWaterMainAttackDamage',
            'mainAttackWaterDamageBonus' => 'waterMainAttackDamage',
            'mainAttackFireDamageBonusRaw' => 'rawFireMainAttackDamage',
            'mainAttackFireDamageBonus' => 'fireMainAttackDamage',
            'mainAttackAirDamageBonusRaw' => 'rawAirMainAttackDamage',
            'mainAttackAirDamageBonus' => 'airMainAttackDamage',
            'mainAttackElementalDamageBonusRaw' => 'rawElementalMainAttackDamage',
            'mainAttackElementalDamageBonus' => 'elementalMainAttackDamage',
            'spellDamageBonusRaw' => 'rawSpellDamage',
            'spellDamageBonus' => 'spellDamage',
            'spellNeutralDamageBonusRaw' => 'rawNeutralSpellDamage',
            'spellNeutralDamageBonus' => 'neutralSpellDamage',
            'spellEarthDamageBonusRaw' => 'rawEarthSpellDamage',
            'spellEarthDamageBonus' => 'earthSpellDamage',
            'spellThunderDamageBonusRaw' => 'rawThunderSpellDamage',
            'spellThunderDamageBonus' => 'thunderSpellDamage',
            'spellWaterDamageBonusRaw' => 'rawWaterSpellDamage',
            'spellWaterDamageBonus' => 'waterSpellDamage',
            'spellFireDamageBonusRaw' => 'rawFireSpellDamage',
            'spellFireDamageBonus' => 'fireSpellDamage',
            'spellAirDamageBonusRaw' => 'rawAirSpellDamage',
            'spellAirDamageBonus' => 'airSpellDamage',
